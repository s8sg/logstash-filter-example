...
```ruby
gem "logstash-filter-naxsi", :path => "/your/local/logstash-filter-naxsi"
```
- Install plugin
```sh
...
```sh
gem build logstash-filter-naxsi.gemspec
```
- Install the plugin from the Logstash home
```sh
bin/plugin install /your/local/plugin/logstash-filter-naxsi.gem
```
